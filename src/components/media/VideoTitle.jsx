      ...
      <div className="max-w-[90vw] sm:max-w-[70vw] lg:max-w-[45vw]">
        ...
        <div className="mt-2 flex flex-wrap gap-2 sm:gap-4">
          ...
          <button
            ...
            className="w-24 rounded-sm bg-gray-600 px-2 py-1 text-[10px] font-bold text-white opacity-80 transition-all duration-150 hover:bg-gray-700 sm:w-36 sm:px-4 sm:py-2 sm:text-sm lg:text-lg"
          >
            &#9432; More info
          </button>
        </div>
